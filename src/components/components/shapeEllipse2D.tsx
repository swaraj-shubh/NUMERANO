...
export default function ShapeEllipse2D() {
  ...
  return (
    ...
    >
      ...
      {/* SVG Ellipse (2D) */}
      <div ref={ellipseRef} className="ellipse2d-glow cursor-pointer">
        <svg width="180" height="140" viewBox="0 0 180 140">
          ...
          {/* Foci */}
          <circle cx="115" cy="70" r="3.5" fill="#0ea5e9" />
          <circle cx="65" cy="70" r="3.5" fill="#0ea5e9" />
          <text x="120" y="65" fill="#0ea5e9" fontSize="10">F</text>
          <text x="55" y="65" fill="#0ea5e9" fontSize="10">F</text>
        </svg>
      </div>
